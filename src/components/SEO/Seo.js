...
const Seo = ({ data }) => {
    ...
    return (
        <Helmet>
            {/* General tags */}
            <title>{decodeHTML(opengraphTitle) || decodeHTML(title)}</title>
            ...
            {/* OpenGraph tags */}
            <meta property="og:url" content={`${process.env.GATSBY_SITE_URL}${opengraphUrl}`} />
            {opengraphType ? <meta property="og:type" content={opengraphType} /> : null}
            <meta property="og:title" content={decodeHTML(opengraphTitle) || decodeHTML(title)} />
            <meta property="og:description" content={metaDesc || ''} />
            <meta property="og:image" content={opengraphImage?.sourceUrl || null} />
